...
public class GestionDeMedicos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Gestion de medicos");
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        if (jTable1.getSelectedRow() > -1) {
            try {
                int medicoId = (int) jTable1.getValueAt(jTable1.getSelectedRow(), 0);
                DAOMedicos dao = new DAOMedicosImpl();
                showpanel(new EditarMedico(dao.getMedicoById(medicoId)));
            } catch (Exception e) {
                System.out.println(e.getMessage());
            }
        } else {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        showpanel(new RegistrarMedicos());
