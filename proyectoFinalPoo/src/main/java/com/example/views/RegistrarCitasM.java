...
public class RegistrarCitasM extends javax.swing.JPanel {

    private int v1;
    private int v2;
    private String nomMedico;
    private String nomPacinte;
    private String especialidad;

    public RegistrarCitasM(int v, String nombre) {
        initComponents();
        initStyles();
        cargarTabla();
        v1 = v;
    ...
    private void initStyles() {
        ...
        userSearch.putClientProperty("JTextField.placeholderText", "Ingrese el nombre del medico a buscar.");
    }
    ...
    private void cargarTabla() {
        try {
            ...
            dao.listar("").forEach((u) -> model.addRow(new Object[]{u.getId(), u.getNombre(), u.getApellido_p(), u.getApellido_m(), u.getTelefono(), u.getEspecialidad()}));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Apellido P.", "Apellido M.", "Teléfono", "Especialidad"
            }
        ) {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(2).setHeaderValue("Apellido P.");
            jTable1.getColumnModel().getColumn(3).setHeaderValue("Apellido M.");
            jTable1.getColumnModel().getColumn(4).setHeaderValue("Teléfono");
            jTable1.getColumnModel().getColumn(5).setHeaderValue("Especialidad");
        }
        ...
        select.setText("Seleccionar medico");
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        try {
            ...
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            model.setRowCount(0);
            dao.listar(nombreBuscar).forEach((u) -> model.addRow(new Object[]{u.getId(), u.getNombre(), u.getApellido_p(), u.getApellido_m(), u.getTelefono(), u.getEspecialidad()}));
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
    ...
    private void selectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectActionPerformed
        ...
        if (jTable1.getSelectedRow() > -1) {
            for (int i : jTable1.getSelectedRows()) {
                v2 = (int) jTable1.getValueAt(i, 0);
                nomMedico = (String) jTable1.getValueAt(i, 1);
                especialidad = (String) jTable1.getValueAt(i, 5);

                cita.setId_paciente(v1);
                cita.setId_medico(v2);
                cita.setNomMedico(nomMedico);
                cita.setNomPaciente(nomPacinte);
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Debe seleccionar un medico. \n", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
